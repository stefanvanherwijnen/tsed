import {JsonSecurityRequirementObject, JsonSerializerOptions} from "../interfaces";
...
export interface JsonOperationOptions {
  ...
  deprecated: boolean;
  security?: JsonSecurityRequirementObject[];
  responses: any;
...
export class JsonOperation extends JsonMap<JsonOperationOptions> {
  ...
  security(security: JsonSecurityRequirementObject): this {
